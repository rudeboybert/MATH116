...
great way to document your code for others, but most importantly yourself in the
future!
* You do not need to understand the code below for now; we'll be learning these
packages in the upcoming weeks.
...
The code below shows the popularity trend for the name "Michael" amongst males. 
