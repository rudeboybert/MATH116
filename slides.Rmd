...
In Lec 36 LC we saw the relationship between $x =$ dep delay &
$y =$ arr delay for Alaska Airlines flights.
...
<center><img src="assets/figure/residuals/lec24-002.png" alt="Drawing" style="width: 400px;"/></center>
...
<center><img src="assets/figure/residuals/lec24-004.png" alt="Drawing" style="width: 400px;"/></center>
...
<center><img src="assets/figure/residuals/lec24-005.png" alt="Drawing" style="width: 400px;"/></center>
...
<center><img src="assets/figure/residuals/lec24-006.png" alt="Drawing" style="width: 400px;"/></center>
...
<center><img src="assets/figure/residuals/lec24-007.png" alt="Drawing" style="width: 400px;"/></center>
...
<center><img src="assets/figure/residuals/lec24-008.png" alt="Drawing" style="width: 400px;"/></center>
...
* In Lec35 LC you all created your own 95% C.I. to estimate
the proportion $p$ of the OkCupid dataset which is female
...
Finally the left and right end points of the 95% confidence interval. Whose
CI's captured the true $p=0.4023$?
...
<!--
* Using OkCupid heights in Lec 32-34, we did a **theoretical** exercise 
showing how $\overline{x}$ behaves over many, many, many samples of size `n=5`,
`n=10`, and `n=100`.
* As `n` increases, *sampling distribution* gets narrow. In other words,
*standard* error goes down.
* In real life
    + We won't know the true population parameter
    + We take only one sample, not many, many, many
    + Hence we can't use sd(something) to get SE, rather use mathematical approximation

## In General

* If n is large, the sampling distribution is normally distributed. Why?
Central Limit Theorem from MATH 310 Probability
* Then we can use the 95% +/- 2 SD rule
* A 95% $\mbox{PE} \pm 1.96\times \mbox{SE}$
* Interpretation
...
For large $n$, the sampling distribution for these point estimates are 
...
<a target="_blank" class="page-link" href="http://n.pr/1f3TnW8">NPR report on
Obama</a> from 2013. Chalk talk...
...
p_hat = 0.41
SE for p_hat = 0.0108
Margin of Error = 1.96*0.0108 = 0.02109137
95% CI = [0.389, 0.431]
crucial question
-->
