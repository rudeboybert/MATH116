...
# help files. For example, you can access the help file for the `movies` data
# set below by typing `?movies`
...
# when we study data manipulation.
data(movies)
movies <- movies %>%
  sample_n(1000) %>%
...
# a)
# You want to know for these 1000 randomly chosen movies: What is the
...
# b)
# As best you can, answer this question: Within these 1000 movies, do comedies
# get rated higher than non-comedies?
...
# a)
# I want to know about popularity trends of the name "Casey" as a male name and
# as a female name over the years. In the code block below, write the code that
