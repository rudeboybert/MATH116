...
**Solution**: Overall, gold seems to be trending down, while bitcoin has definitely not recovered from its peak value in late 2013.
...
And observe. It is now the end of week 5, and only now do we see our first formula.
...
Cheese wins by a landlide. 2100% increase.
