...
> * We can model any random simulation by tinkering with these 8 attributes of Powerball:




## Attributes of a Random Simulation via Powerball
...
* Drawing balls:
    ...
    * What to do with a ball after you've drawn it?
* Number of lotteries:
