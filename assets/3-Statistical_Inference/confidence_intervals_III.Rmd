...
## Two Methods to Construct 95% Confidence Intervals
...
```{r, echo=FALSE}
ggplot(data.frame(x = c(-4, 12)), aes(x)) + 
...
>     + i.e. the interval [\mu - 2\times\sigma, \mu + 2 \times\sigma] contains 95% of values


## Method 2: Data Bell Shaped

Below we have a Normal Distribution with $\mu=4$ and $\sigma=2$...
...
So the interval $[\mu -2\times\sigma, \mu +2\times\sigma] = [4 -2\times 2, 4 +2\times 2] = [0, 8]$ contains 95% of values
