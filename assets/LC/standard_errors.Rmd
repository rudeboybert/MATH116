...
**Mathematically**: You can derive the standard error mathematically, but this is for a more advanced class in probability. See Advanced section below.
...
**Recall**: The sampling distribution is the distribution of the point estimate. We see that for `n=50`
