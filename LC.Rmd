...
As described in today's lecture slides, in RStudio
...
1. Typing them directly in the console and pressing enter.
1. Typing them in an *R Script* (which you can save) and passing them to the console.
...
* Save the file as `babynames`. Note:
    ...
    + You should see this file in your File panel:
* Cut/paste the contents of the grey block below into `babynames.R` and save it again.
* Run the code that loads packages in the console by highlighting it and pressing
...
# males. Switch the name/sex variable values that get assigned and explore the 
# popularity of different names. 
# 
# You do not need to understand this code for now. Just run it.
baby_name <- "Jeffrey"
baby_sex <- "M"
