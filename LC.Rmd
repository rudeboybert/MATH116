...
draw on paper the 5 graphics below:
...
**BONUS**: A little ambitious right now, but see if you can change the code below to
create the first graphic. I suggest you:

1. Create a new `.R` script file
1. Cut and paste the code below
1. Tweak the code from your Editor (not directly in console)
