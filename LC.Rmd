...
So 239 times out of 1000 we observed a simulated test statistic either

1. less than -0.073
1. greater than 0.073

The p-value is 0.239. Note that we add one to the numerator to include the actually
observed difference of means of -0.073.

$$
p-\mbox{Value} = \frac{239+1}{1000} = 0.240.
$$
